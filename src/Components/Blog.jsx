...
const Blog = ({ blog }) => {
    ...
    return (
        <div className="flex relative">
            <div
                className=" p-2 mx-auto group  transition border-2 hover:scale-105  border-primary hover:border-secondary border-opacity-30 hover:no-underline focus:no-underline font-serif">
